...
<form action="/san-pham/add" method="post">
    <div class="mb-3">
        <label for="tenDem" class="form-label">mã sản phẩm</label>
        <input type="text" class="form-control" id="tenDem" name="ma" value="${sanPham.ma}">
    </div>
    <div class="mb-3">
...
<table class="table">
    ...
    <c:forEach items="${listSanPham}" var="sp" varStatus="i">
        <tr>
            ...
            <td>${sp.ten}</td>
            <td>
                <a href="/san-pham/remove/${sp.id}" type="button" class="btn btn-danger">delete</a>
                <a href="/san-pham/detail/${sp.id}" type="button" class="btn btn-info">detail</a>
                <a href="/san-pham/view-update/${sp.id}" type="button" class="btn btn-warning">update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
