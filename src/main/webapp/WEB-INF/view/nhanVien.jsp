...
<table class="table">
    ...
    <c:forEach items="${listNhanVien}" var="nv" varStatus="i">
        <tr>
            ...
            <td>${nv.trangThai}</td>
            <td>
                <a href="/nhan-vien/remove/${nv.id}" type="button" class="btn btn-danger">delete</a>
                <a href="/nhan-vien/detail/${nv.id}" type="button" class="btn btn-info">detail</a>
                <a href="/nhan-vien/view-update/${nv.id}" type="button" class="btn btn-warning">update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
