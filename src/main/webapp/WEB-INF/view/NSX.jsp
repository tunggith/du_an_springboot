...
<table class="table">
    ...
    <tbody>
    <c:forEach items="${listNsx}" var="sp" varStatus="i">
        <tr>
            ...
            <td>${sp.ten}</td>
            <td>
                <a href="/nha-san-xuat/remove/${sp.id}" type="button" class="btn btn-danger">delete</a>
                <a href="/nha-san-xuat/detail/${sp.id}" type="button" class="btn btn-info">detail</a>
                <a href="/nha-san-xuat/view-update/${sp.id}" type="button" class="btn btn-warning">update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
