...
<table class="table">
    ...
    <tbody>
    <c:forEach items="${listMauSac}" var="sp" varStatus="i">
        <tr>
            ...
            <td>${sp.ten}</td>
            <td>
                <a href="/mau-sac/remove/${sp.id}" type="button" class="btn btn-danger">delete</a>
                <a href="/mau-sac/detail/${sp.id}" type="button" class="btn btn-info">detail</a>
                <a href="/mau-sac/view-update/${sp.id}" type="button" class="btn btn-warning">update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
